...
if __name__ == "__main__":
    ...
    epoch_limit_minutes = a.epoch_limit_minutes
    ...
    train.main(conf, epochs, trials, min_batch_power, max_batch_power, min_lr, max_lr, min_mom, max_mom, min_drop, max_drop, transform, nn_fail_attempts, random_config_order, workers, pretrained, epoch_limit_minutes)
